...
<div class="mb-6">
    ...
    <p class="text-sm text-gray-600 dark:text-neutral-400">Gérez votre profil personnel et vos préférences de notification.</p>
</div>
...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
    ...
    <div class="lg:col-span-2 space-y-6">
        ...
        <div class="bg-white border border-gray-200 shadow-sm rounded-xl p-6 dark:bg-neutral-800 dark:border-neutral-700">
            <h3 class="text-lg font-bold text-gray-800 dark:text-white mb-4">Profil Résident</h3>
            <form onsubmit="event.preventDefault();">
                ...
                <div class="mb-4">
                    <label for="apartment" class="block text-sm font-medium mb-2 dark:text-white">Mon Appartement & Immeuble</label>
        ...
        <div class="bg-white border border-gray-200 shadow-sm rounded-xl p-6 dark:bg-neutral-800 dark:border-neutral-700">
            ...
            <ul class="flex flex-col gap-y-4">
                <li class="flex items-center justify-between">
                    <div>
                        <span class="block text-sm font-medium text-gray-800 dark:text-white">Nouvelle Charge Mensuelle</span>
                        <span class="block text-xs text-gray-500 dark:text-neutral-400">Alerte lors de la création d'un avis.</span>
                    </div>
                ...
                <li class="flex items-center justify-between">
                    <div>
                        <span class="block text-sm font-medium text-gray-800 dark:text-white">Suivi des Signalements</span>
                        <span class="block text-xs text-gray-500 dark:text-neutral-400">Rapports d'intervention technique.</span>
                    </div>
                ...
                <li class="flex items-center justify-between">
                    <div>
                        <span class="block text-sm font-medium text-gray-800 dark:text-white">Annonces & Bulletins</span>
                        <span class="block text-xs text-gray-500 dark:text-neutral-400">Diffusion d'avis de la résidence.</span>
                    </div>
