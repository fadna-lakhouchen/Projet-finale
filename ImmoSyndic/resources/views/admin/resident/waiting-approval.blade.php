        ...
        <div class="p-6 sm:p-8">
            <div class="text-center">
                ...
                <div class="flex justify-center mb-6">
                    <img src="{{ asset('logo.png') }}" alt="Logo ImmoSyndic" class="h-16 w-auto object-contain">
                </div>
                ...
                <h1 class="block text-2xl font-bold text-gray-800 dark:text-white">Compte en attente</h1>
            ...
            <div class="mt-6 space-y-4">
                ...
                <div class="border border-gray-100 dark:border-neutral-800 rounded-xl p-4 space-y-3 bg-gray-50/50 dark:bg-neutral-900/50">
                    <h3 class="text-xs font-bold uppercase tracking-wider text-gray-400 dark:text-neutral-500">Détails de l'inscription</h3>
                    
                    <div class="flex justify-between items-center text-sm">
                        <span class="text-gray-500 dark:text-neutral-400">Immeuble</span>
                        <span class="font-semibold text-gray-800 dark:text-neutral-200">{{ $immeuble ? $immeuble->nom : 'N/A' }}</span>
                    </div>

                    <div class="flex justify-between items-center text-sm">
                        <span class="text-gray-500 dark:text-neutral-400">Appartement</span>
                        <span class="font-semibold text-gray-800 dark:text-neutral-200">{{ $appt ? 'Appt ' . $appt->numero : 'N/A' }}</span>
                    </div>

                    <div class="flex justify-between items-center text-sm">
                        <span class="text-gray-500 dark:text-neutral-400">Statut du compte</span>
