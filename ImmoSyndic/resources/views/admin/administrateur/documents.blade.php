                            ...
                            <div>
                                ...
                                <div class="relative" x-data="{ open: false }">
                                    ...
                                    <div x-show="open" x-cloak class="absolute left-0 top-full z-[100] mt-2 w-full bg-white dark:bg-[#0D121F] border border-gray-200/60 dark:border-slate-800/60 shadow-xl rounded-xl p-1.5 backdrop-blur-md" style="display: none;">
                                        ...
                                        <div @click="documentEnCours.categorie = 'PV'; open = false" class="cursor-pointer py-2 px-3 rounded-lg text-sm text-gray-700 dark:text-slate-300 hover:bg-gray-100 dark:hover:bg-slate-800/50 transition-colors">Rapport de Réunion (PV)</div>
