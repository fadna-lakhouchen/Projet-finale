            ...
            <table class="min-w-full divide-y divide-gray-200 dark:divide-neutral-700">
                <thead class="bg-gray-50 dark:bg-neutral-800">
                    <tr>
                        ...
                        <th class="px-6 py-3 text-start text-xs font-medium text-gray-500 uppercase">Logement</th>
                ...
                <tbody class="divide-y divide-gray-200 dark:divide-neutral-700">
                    ...
                    <tr x-show="matches('{{ $resident->prenom }} {{ $resident->nom }}', '{{ $immeubleName }}', '{{ $typeResident }}')" class="hover:bg-gray-50 dark:hover:bg-neutral-800 transition-colors">
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center gap-x-3">
                                ...
                                <div class="grow">
                                    ...
                                    <span class="block text-sm text-gray-500 dark:text-neutral-400"><i data-lucide="mail" class="inline size-3 me-1"></i>{{ $resident->email }}</span>
                                    @if($resident->telephone)
                                        <span class="block text-sm text-gray-500 dark:text-neutral-400"><i data-lucide="phone" class="inline size-3 me-1"></i>{{ $resident->telephone }}</span>
                                    @endif
                                </div>
                            </div>
                        </td>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <span class="inline-flex items-center py-1.5 px-3 mb-1 rounded-full text-xs font-medium {{ $typeResident === 'Propriétaire' ? 'bg-purple-100 text-purple-800' : 'bg-blue-100 text-blue-800' }}">
                                {{ $typeResident }}
                            </span>
                            @if($appt && $appt->pivot->date_entree)
                                <span class="block text-xs text-gray-500 dark:text-neutral-400 mt-1">
