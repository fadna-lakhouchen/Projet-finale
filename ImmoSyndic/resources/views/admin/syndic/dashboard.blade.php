        ...
        <div class="w-full flex flex-col bg-white dark:bg-[#0D121F] border border-gray-200/60 dark:border-slate-800/60 shadow-premium rounded-2xl pointer-events-auto overflow-hidden">
            ...
            <form action="{{ route('syndic.interventions.store') }}" method="POST">
                ...
                <div class="p-6 space-y-4">
                    ...
                    <div>
                        <label class="block text-sm font-semibold mb-2 dark:text-neutral-200">Priorité de l’incident</label>
                        <div class="relative w-full inline-flex">
                            ...
                            <div x-show="openPrioriteDropdown" x-cloak class="absolute left-0 top-full z-[100] mt-2 w-full bg-white dark:bg-[#0D121F] border border-gray-200/60 dark:border-slate-800/60 shadow-xl rounded-xl p-1.5 backdrop-blur-md">
                                <button type="button" @click="selectPriorite('basse')" class="w-full text-start flex items-center py-2.5 px-3 rounded-lg text-sm text-gray-700 dark:text-slate-350 hover:bg-gray-150 dark:hover:bg-slate-800/50 transition-colors">Basse</button>
                                <button type="button" @click="selectPriorite('moyenne')" class="w-full text-start flex items-center py-2.5 px-3 rounded-lg text-sm text-gray-700 dark:text-slate-350 hover:bg-gray-150 dark:hover:bg-slate-800/50 transition-colors">Moyenne</button>
                                <button type="button" @click="selectPriorite('haute')" class="w-full text-start flex items-center py-2.5 px-3 rounded-lg text-sm text-gray-700 dark:text-slate-350 hover:bg-gray-150 dark:hover:bg-slate-800/50 transition-colors">Haute</button>
                                <button type="button" @click="selectPriorite('urgente')" class="w-full text-start flex items-center py-2.5 px-3 rounded-lg text-sm text-gray-700 dark:text-slate-350 hover:bg-gray-150 dark:hover:bg-slate-800/50 transition-colors">Urgente</button>
                            </div>
                        </div>
                    </div>
                ...
                <div class="flex justify-end items-center gap-x-3 py-4 px-6 border-t border-gray-200/60 dark:border-slate-800/60 bg-slate-50/50 dark:bg-slate-900/30">
                    ...
                    <button type="submit" class="py-2.5 px-4 inline-flex items-center gap-x-2 text-sm font-bold rounded-xl border border-transparent bg-gradient-to-r from-primary-600 to-purple-600 text-white hover:from-primary-700 hover:to-purple-700 shadow-md shadow-primary-500/15 transition-all glow-hover">Créer le signalement</button>
                </div>
            </form>
        </div>
    </div>
