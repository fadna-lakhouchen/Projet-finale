...
<div x-data="syndicLogsComponent({{ json_encode($logs->map(function($log) {
    ...
    <div class="flex flex-col md:flex-row md:items-end justify-between gap-4">
        <div>
            <h2 class="text-3xl font-extrabold text-gray-900 tracking-tight dark:text-white">Journal d'Activité de l'Équipe</h2>
            <p class="mt-1 text-sm text-gray-500 dark:text-slate-400">
                Visualisez et suivez l'historique complet de toutes les actions de création, modification et suppression effectuées par les syndics secondaires.
            </p>
        </div>
    </div>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center gap-x-3">
                                    ...
                                    <div class="flex flex-col">
                                        ...
                                        <span class="text-[10px] font-bold text-slate-400 dark:text-neutral-450 uppercase tracking-wider mt-0.5">Syndic Secondaire</span>
                                    </div>
                                </div>
                            </td>
                    ...
                    <tr x-show="filteredLogs.length === 0">
                        <td colspan="6" class="px-6 py-12 text-center text-sm text-gray-500 dark:text-slate-400">
                            <div class="flex flex-col items-center justify-center gap-2">
                                ...
                                <span class="font-medium">Aucun log d'activité ne correspond à vos filtres.</span>
                            </div>
                        </td>
                    </tr>
                </tbody>
