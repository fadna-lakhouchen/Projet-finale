...
class SubscriptionBillingTest extends TestCase
{
    ...
    public function test_inactive_syndic_is_blocked_by_middleware(): void
    {
        ...
        $response->assertSessionHasErrors([
            'email' => 'Votre compte Syndic a été suspendu pour défaut de paiement. Veuillez effectuer le virement bancaire mensuel hors-ligne et contacter l\'administrateur pour réactiver votre accès.'
        ]);
