...
Route::post('/auth/google/redirect', [\App\Http\Controllers\Auth\GoogleAuthController::class, 'redirectToGoogle'])->name('auth.google.redirect.post');
...
Route::get('/register/cancel-google', [\App\Http\Controllers\Auth\GoogleAuthController::class, 'cancelGoogleRegistration'])->name('register.cancel-google');
...
Route::middleware(['auth', 'verified'])->group(function () {
    Route::get('/switch-role/{role}', [DashboardController::class, 'switchRole'])->name('role.switch');
    ...
    Route::group(['prefix' => 'admin', 'middleware' => 'role:administrateur'], function () {
        ...
        Route::get('/syndics/{id}/abonnements', [UserController::class, 'showSyndicAbonnements'])->name('admin.syndics.abonnements');
        Route::post('/abonnements/{id}/update', [UserController::class, 'updateSyndicAbonnement'])->name('admin.syndics.abonnements.update');
