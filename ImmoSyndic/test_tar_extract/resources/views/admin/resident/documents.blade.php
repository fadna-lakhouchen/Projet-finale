...
<div x-data="residentDocuments" class="space-y-8">
    ...
    <div class="flex flex-col md:flex-row md:items-end justify-between gap-4">
        <div>
            <h2 class="text-3xl font-extrabold text-gray-900 tracking-tight dark:text-white">{{ __('Documents de la Copropriété') }}</h2>
            <p class="mt-1 text-sm text-gray-500 dark:text-slate-400">
                {{ __('Consultez et téléchargez les rapports de réunions, contrats et documents officiels de l\'immeuble') }}
            ...
            <table class="min-w-full divide-y divide-gray-200/60 dark:divide-slate-800/60">
                <thead class="bg-gray-50/50 dark:bg-[#090D16]/40">
                    <tr>
                        ...
                        <th class="px-6 py-4 text-start text-xs font-semibold text-gray-500 uppercase tracking-wider dark:text-slate-400">{{ __('Date de partage') }}</th>
                ...
                <tbody class="divide-y divide-gray-200/60 dark:divide-slate-800/60">
                    ...
                    <tr x-show="matches('{{ addslashes($doc->titre) }}', '{{ $doc->categorie }}')" class="hover:bg-gray-50/50 dark:hover:bg-slate-900/30 transition-colors duration-150">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-end text-sm font-medium">
                            <!-- Download button -->
                            <a href="{{ $doc->url }}" target="_blank" download class="py-1.5 px-3 inline-flex items-center gap-x-2 text-xs font-semibold rounded-xl border border-gray-200 bg-white hover:bg-gray-50 text-gray-800 dark:bg-slate-800 dark:border-slate-700 dark:text-white dark:hover:bg-slate-700 transition-all duration-200" title="{{ __('Télécharger') }}">
                                <i data-lucide="download" class="size-3.5"></i>{{ __('Télécharger') }}</a>
                        </td>
                    </tr>
                    @empty
                    <tr>
                        <td colspan="5" class="px-6 py-12 text-center text-sm text-gray-500 dark:text-slate-400">
                            <div class="flex flex-col items-center justify-center gap-2">
                                ...
                                <span class="font-medium">{{ __('Aucun document officiel partagé pour votre immeuble pour le moment.') }}</span>
                            </div>
                        </td>
                    </tr>
                    @endforelse
