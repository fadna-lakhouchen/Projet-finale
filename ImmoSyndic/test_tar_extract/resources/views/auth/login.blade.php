    ...
    <div class="bg-white border border-gray-200 rounded-xl shadow-sm dark:bg-neutral-800 dark:border-neutral-700">
        <div class="p-4 sm:p-7">
            <div class="text-center">
                ...
                <h1 class="block text-2xl font-bold text-gray-800 dark:text-white">{{ __('Bienvenue chez ImmoSyn') }}</h1>
            ...
            <div class="mt-5">
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="grid gap-y-4">
                        ...
                        <div>
                            <label for="email" class="block text-sm mb-2 dark:text-white">{{ __('Adresse email') }}</label>
                            <div class="relative">
                        ...
                        <div>
                            <div class="flex justify-between items-center">
                                <label for="password" class="block text-sm mb-2 dark:text-white">{{ __('Mot de passe') }}</label>
                                @if (Route::has('password.request'))
                                    <a class="text-sm text-primary-600 decoration-2 hover:underline font-medium dark:text-primary-400" href="{{ route('password.request') }}">{{ __('Mot de passe oublié ?') }}</a>
                                @endif
                            </div>
                            <div class="relative">
                        ...
                        <div class="flex items-center">
                            ...
                            <div class="ms-3">
                                <label for="remember" class="text-sm dark:text-white">{{ __('Se souvenir de moi') }}</label>
                            </div>
                        </div>
