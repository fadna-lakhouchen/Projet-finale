@php
    $roleLabel = match(auth()->user()->active_role) {
        'administrateur', 'admin' => __('Super Admin'),
        'syndic' => __('Syndic Référent'),
        default => __('Résident'),
    };
@endphp
        ...
        <div class="px-6 flex items-center gap-x-3 mb-8">
            <a class="flex items-center gap-x-3 group" href="{{ route('dashboard') }}">
                ...
                <div class="flex flex-col justify-center">
                    <span class="text-xl font-extrabold text-white tracking-tight leading-none group-hover:text-primary-400 transition-colors">Immo<span class="text-primary-500">Syn</span></span>
                </div>
            </a>
        </div>
        ...
        <nav class="p-4 w-full flex flex-col flex-wrap">
            <ul class="space-y-1.5">
                ...
                @if(auth()->user()->isAdministrateur())
                    <li class="px-3 mb-2">
                        <span class="text-[10px] font-bold text-slate-500 uppercase tracking-widest">{{ __('Supervision') }}</span>
                    </li>
                    <li>
                        <a class="flex items-center gap-x-3.5 py-2.5 px-3 rounded-xl text-sm font-medium transition-all duration-300 group border-s-2 {{ request()->routeIs('admin.dashboard') ? 'bg-primary-500/10 border-primary-500 text-primary-400 shadow-sm shadow-primary-500/5' : 'text-slate-400 hover:text-white hover:bg-white/5 border-transparent hover:border-slate-800' }}" href="{{ route('admin.dashboard') }}">
                            <i data-lucide="layout-dashboard" class="size-4.5 shrink-0 group-hover:scale-105 transition-transform"></i> {{ __('Dashboard') }}
                        </a>
                    </li>
                    <li>
                        <a class="flex items-center gap-x-3.5 py-2.5 px-3 rounded-xl text-sm font-medium transition-all duration-300 group border-s-2 {{ request()->routeIs('admin.immeubles') ? 'bg-primary-500/10 border-primary-500 text-primary-400 shadow-sm shadow-primary-500/5' : 'text-slate-400 hover:text-white hover:bg-white/5 border-transparent hover:border-slate-800' }}" href="{{ route('admin.immeubles') }}">
                            <i data-lucide="building" class="size-4.5 shrink-0 group-hover:scale-105 transition-transform"></i> {{ __('Immeubles') }}
                        </a>
                    </li>
                    <li>
                        <a class="flex items-center gap-x-3.5 py-2.5 px-3 rounded-xl text-sm font-medium transition-all duration-300 group border-s-2 {{ request()->routeIs('admin.residents') ? 'bg-primary-500/10 border-primary-500 text-primary-400 shadow-sm shadow-primary-500/5' : 'text-slate-400 hover:text-white hover:bg-white/5 border-transparent hover:border-slate-800' }}" href="{{ route('admin.residents') }}">
                            <i data-lucide="users" class="size-4.5 shrink-0 group-hover:scale-105 transition-transform"></i> {{ __('Résidents') }}
                        </a>
                    </li>
                    <li>
                        <a class="flex items-center gap-x-3.5 py-2.5 px-3 rounded-xl text-sm font-medium transition-all duration-300 group border-s-2 {{ request()->routeIs('admin.syndics') ? 'bg-primary-500/10 border-primary-500 text-primary-400 shadow-sm shadow-primary-500/5' : 'text-slate-400 hover:text-white hover:bg-white/5 border-transparent hover:border-slate-800' }}" href="{{ route('admin.syndics') }}">
                            <i data-lucide="user-cog" class="size-4.5 shrink-0 group-hover:scale-105 transition-transform"></i> {{ __('Syndics') }}
                        </a>
                    </li>
                    <li>
                        <a class="flex items-center gap-x-3.5 py-2.5 px-3 rounded-xl text-sm font-medium transition-all duration-300 group border-s-2 {{ request()->routeIs('admin.paiements') ? 'bg-primary-500/10 border-primary-500 text-primary-400 shadow-sm shadow-primary-500/5' : 'text-slate-400 hover:text-white hover:bg-white/5 border-transparent hover:border-slate-800' }}" href="{{ route('admin.paiements') }}">
                            <i data-lucide="wallet" class="size-4.5 shrink-0 group-hover:scale-105 transition-transform"></i> {{ __('Paiements') }}
                        </a>
                    </li>
                    <li>
                        <a class="flex items-center gap-x-3.5 py-2.5 px-3 rounded-xl text-sm font-medium transition-all duration-300 group border-s-2 {{ request()->routeIs('admin.depenses') ? 'bg-primary-500/10 border-primary-500 text-primary-400 shadow-sm shadow-primary-500/5' : 'text-slate-400 hover:text-white hover:bg-white/5 border-transparent hover:border-slate-800' }}" href="{{ route('admin.depenses') }}">
                            <i data-lucide="receipt" class="size-4.5 shrink-0 group-hover:scale-105 transition-transform"></i> {{ __('Dépenses') }}
                        </a>
                    </li>
                    <li>
                        <a class="flex items-center gap-x-3.5 py-2.5 px-3 rounded-xl text-sm font-medium transition-all duration-300 group border-s-2 {{ request()->routeIs('admin.documents') ? 'bg-primary-500/10 border-primary-500 text-primary-400 shadow-sm shadow-primary-500/5' : 'text-slate-400 hover:text-white hover:bg-white/5 border-transparent hover:border-slate-800' }}" href="{{ route('admin.documents') }}">
                            <i data-lucide="folder-open" class="size-4.5 shrink-0 group-hover:scale-105 transition-transform"></i> {{ __('Documents') }}
                        </a>
                    </li>
                    <li class="pt-4 mt-4 border-t border-slate-800">
                        <span class="px-3 text-[10px] font-bold text-slate-500 uppercase tracking-widest">{{ __('Configuration') }}</span>
                    </li>
                    <li>
                        <a class="flex items-center gap-x-3.5 py-2.5 px-3 rounded-xl text-sm font-medium transition-all duration-300 group border-s-2 {{ request()->routeIs('admin.parametres') ? 'bg-primary-500/10 border-primary-500 text-primary-400 shadow-sm shadow-primary-500/5' : 'text-slate-400 hover:text-white hover:bg-white/5 border-transparent hover:border-slate-800' }}" href="{{ route('admin.parametres') }}">
                            <i data-lucide="settings" class="size-4.5 shrink-0 group-hover:scale-105 transition-transform"></i> {{ __('Paramètres') }}
                        </a>
                    </li>
                    <li>
                        <a class="flex items-center gap-x-3.5 py-2.5 px-3 rounded-xl text-sm font-medium transition-all duration-300 group border-s-2 {{ request()->routeIs('admin.logs') ? 'bg-primary-500/10 border-primary-500 text-primary-400 shadow-sm shadow-primary-500/5' : 'text-slate-400 hover:text-white hover:bg-white/5 border-transparent hover:border-slate-800' }}" href="{{ route('admin.logs') }}">
                            <i data-lucide="scroll-text" class="size-4.5 shrink-0 group-hover:scale-105 transition-transform"></i> {{ __('Logs Système') }}
                        </a>
                    </li>
                @endif
                ...
                @if(auth()->user()->isSyndic())
                    <li class="px-3 mb-2">
                        <span class="text-[10px] font-bold text-slate-500 uppercase tracking-widest">{{ __('Gestion Syndic') }}</span>
                    </li>
                    <li>
                    ...
                    <li>
                        <a class="flex items-center gap-x-3.5 py-2.5 px-3 rounded-xl text-sm font-medium transition-all duration-300 group border-s-2 {{ request()->routeIs('syndic.immeubles') ? 'bg-primary-500/10 border-primary-500 text-primary-400 shadow-sm shadow-primary-500/5' : 'text-slate-400 hover:text-white hover:bg-white/5 border-transparent hover:border-slate-800' }}" href="{{ route('syndic.immeubles') }}">
                            <i data-lucide="building" class="size-4.5 shrink-0 group-hover:scale-105 transition-transform"></i> {{ __('Mes Immeubles') }}
                        </a>
                    </li>
                    <li>
                        <a class="flex items-center gap-x-3.5 py-2.5 px-3 rounded-xl text-sm font-medium transition-all duration-300 group border-s-2 {{ request()->routeIs('syndic.residents') ? 'bg-primary-500/10 border-primary-500 text-primary-400 shadow-sm shadow-primary-500/5' : 'text-slate-400 hover:text-white hover:bg-white/5 border-transparent hover:border-slate-800' }}" href="{{ route('syndic.residents') }}">
                            <i data-lucide="users" class="size-4.5 shrink-0 group-hover:scale-105 transition-transform"></i> {{ __('Mes Résidents') }}
                        </a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a class="flex items-center gap-x-3.5 py-2.5 px-3 rounded-xl text-sm font-medium transition-all duration-300 group border-s-2 {{ request()->routeIs('syndic.interventions') ? 'bg-primary-500/10 border-primary-500 text-primary-400 shadow-sm shadow-primary-500/5' : 'text-slate-400 hover:text-white hover:bg-white/5 border-transparent hover:border-slate-800' }}" href="{{ route('syndic.interventions') }}">
                            <i data-lucide="wrench" class="size-4.5 shrink-0 group-hover:scale-105 transition-transform"></i> {{ __('Interventions') }}
                        </a>
                    </li>
                    <li>
                        <a class="flex items-center gap-x-3.5 py-2.5 px-3 rounded-xl text-sm font-medium transition-all duration-300 group border-s-2 {{ request()->routeIs('syndic.annonces') ? 'bg-primary-500/10 border-primary-500 text-primary-400 shadow-sm shadow-primary-500/5' : 'text-slate-400 hover:text-white hover:bg-white/5 border-transparent hover:border-slate-800' }}" href="{{ route('syndic.annonces') }}">
                            <i data-lucide="megaphone" class="size-4.5 shrink-0 group-hover:scale-105 transition-transform"></i> {{ __('Annonces') }}
                        </a>
                    </li>
                    <li>
                    ...
                    @if(\App\Models\Immeuble::where('syndic_id', auth()->id())->exists())
                        <li class="pt-4 mt-4 border-t border-slate-800">
                            <span class="px-3 text-[10px] font-bold text-slate-500 uppercase tracking-widest">{{ __('Supervision') }}</span>
                        </li>
                        <li>
                            <a class="flex items-center gap-x-3.5 py-2.5 px-3 rounded-xl text-sm font-medium transition-all duration-300 group border-s-2 {{ request()->routeIs('syndic.secondary-syndics') ? 'bg-primary-500/10 border-primary-500 text-primary-400 shadow-sm shadow-primary-500/5' : 'text-slate-400 hover:text-white hover:bg-white/5 border-transparent hover:border-slate-800' }}" href="{{ route('syndic.secondary-syndics') }}">
                                <i data-lucide="users" class="size-4.5 shrink-0 group-hover:scale-105 transition-transform"></i> {{ __('Gestion de l\'équipe') }}
                            </a>
                        </li>
                        <li>
                            <a class="flex items-center gap-x-3.5 py-2.5 px-3 rounded-xl text-sm font-medium transition-all duration-300 group border-s-2 {{ request()->routeIs('syndic.logs') ? 'bg-primary-500/10 border-primary-500 text-primary-400 shadow-sm shadow-primary-500/5' : 'text-slate-400 hover:text-white hover:bg-white/5 border-transparent hover:border-slate-800' }}" href="{{ route('syndic.logs') }}">
                                <i data-lucide="scroll-text" class="size-4.5 shrink-0 group-hover:scale-105 transition-transform"></i> {{ __('Journal d\'Activité') }}
                            </a>
                        </li>
                    @endif
                ...
                @if(auth()->user()->isResident())
                    <li class="px-3 mb-2">
                        <span class="text-[10px] font-bold text-slate-500 uppercase tracking-widest">{{ __('Espace Résident') }}</span>
                    </li>
                    <li>
                    ...
                    <li>
                        <a class="flex items-center gap-x-3.5 py-2.5 px-3 rounded-xl text-sm font-medium transition-all duration-300 group border-s-2 {{ request()->routeIs('resident.paiements') ? 'bg-primary-500/10 border-primary-500 text-primary-400 shadow-sm shadow-primary-500/5' : 'text-slate-400 hover:text-white hover:bg-white/5 border-transparent hover:border-slate-800' }}" href="{{ route('resident.paiements') }}">
                            <i data-lucide="credit-card" class="size-4.5 shrink-0 group-hover:scale-105 transition-transform"></i> {{ __('Paiements') }}
                        </a>
                    </li>
                    <li>
                        <a class="flex items-center gap-x-3.5 py-2.5 px-3 rounded-xl text-sm font-medium transition-all duration-300 group border-s-2 {{ request()->routeIs('resident.incidents') ? 'bg-primary-500/10 border-primary-500 text-primary-400 shadow-sm shadow-primary-500/5' : 'text-slate-400 hover:text-white hover:bg-white/5 border-transparent hover:border-slate-800' }}" href="{{ route('resident.incidents') }}">
                            <i data-lucide="alert-circle" class="size-4.5 shrink-0 group-hover:scale-105 transition-transform"></i> {{ __('Mes Signalements') }}
                        </a>
                    </li>
                    <li>
